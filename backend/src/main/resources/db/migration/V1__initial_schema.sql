...
(
    ...
    security_isin VARCHAR(255),
    internal_position_id BIGINT,
...
(
    ...
    bank_positions_id BIGINT NOT NULL,
...
(
    ...
    CONSTRAINT pk_security_entity PRIMARY KEY (isin)
);
...
ALTER TABLE consolidated_position_entity
    ADD CONSTRAINT FK_CONSOLIDATED_POSITION_ENTITY_ON_SECURITY FOREIGN KEY (security_isin) REFERENCES security_entity (isin);

ALTER TABLE position_entity
    ADD CONSTRAINT FK_POSITION_ENTITY_ON_SECURITY FOREIGN KEY (security_isin) REFERENCES security_entity (isin);
