...
ALTER TABLE consolidated_position_entity
    ADD CONSTRAINT FK_CONSOLIDATED_POSITION_ENTITY_ON_SECURITY FOREIGN KEY (security_id) REFERENCES security_entity (isin);

ALTER TABLE position_entity
    ADD CONSTRAINT FK_POSITION_ENTITY_ON_SECURITY FOREIGN KEY (security_id) REFERENCES security_entity (isin);
